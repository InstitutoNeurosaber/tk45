...
export const NewCommentEmail = ({
  ...
  return (
    <Html>
      <Head>
        <title>Novo Comentário em Ticket</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      </Head>
      <Preview>Novo comentário em: {ticketTitle}</Preview>
      <Tailwind>
            ...
            <Section className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <Section className="px-8 py-6">
                ...
                <Text className="text-gray-700 text-base">
                  Um novo comentário foi adicionado ao ticket. Confira os detalhes abaixo:
                </Text>
                      ...
                      <Row>
                        <Column>
                          <Text className="text-sm font-medium text-blue-800 mb-2">
                            {commentAuthor} comentou:
                          </Text>
                        </Column>
                      </Row>
                      <Text className="text-gray-700 text-sm whitespace-pre-wrap leading-relaxed">
                        {commentText}
                      </Text>
                    </Section>
                  </Section>
                ...
                <Section className="text-center">
                  <Button
                    href={ticketUrl}
                    className="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors no-underline"
                  >
                    Responder
                  </Button>
                </Section>
